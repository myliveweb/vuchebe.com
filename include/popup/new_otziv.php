<div class="hideForm3">
	<div class="foneBg" onClick="close_form();"></div>
  	<div class="form-open-block">
	  	<form id="form-new-post" method="post" action="">
			...
			<div>
				<div class="name_form text-center"><span>Новый отзыв</span></div>
				<div id="error-message-new-post" style="color: red; font-weight: bold; font-size: 20px; height: 24px; margin-bottom: 15px; display: none;"></div>
				...
				<div class="row-line mt-10">
					<div class="col-12">
						<textarea name="message_post" class="message_post" class="notes js-new-post"></textarea>
					</div>
				</div>
				<div class="row-line mb-10 mt-15">
					<div class="col-4">
						<button type="submit" class="js-submit-new-post"><span>Отправить</span></button>
					</div>
				</div>
