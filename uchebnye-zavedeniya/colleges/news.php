...
<div style="text-align: center; margin: -5px auto 25px auto;">
	<span class="color-silver js-new-add" data-vuz="<?=$arResult["ID"]?>" data-type="news" data-iblock="3" style="cursor: pointer; border-bottom: 1px dashed #9f9f9f;">Добавить новость</span>
</div>
<?php } ?>
<?php
global $dbh;
...
if($_REQUEST['s']) {
	...
	$arFilter = array("IBLOCK_ID" => 28, "ACTIVE" => "Y", "ID" => $id_news);
...
<div class="name-block text-center txt-up"><span>Новости колледжа</span></div>
<div class="st-content-bottom clear">
	<div class="module st-news">
		<div class="line" id="box-line" data-url="<?=$arResult["DETAIL_PAGE_URL"]?>?sect=news">
			...
			<div class="news-item one" style="position: relative;">
				<?if($pageAdmin):?>
				<div class="color-silver js-news-edit" data-block="news" data-id="<?php echo $news_item["ID"]; ?>" data-iblock="3" style="position: absolute; right: 5px; cursor: pointer; border-bottom: 1px dashed #9f9f9f;">изменить</div>
				<?endif?>
	...
	<div class="st-carousel news-3">
		<div class="owl-carousel">
			...
			$arFilter = array("IBLOCK_ID" => 28, "ACTIVE" => "Y", "PROPERTY_VUZ_ID" => $arResult["ID"], "!ID" => $news_item["ID"]);
...
<?php
	...
	echo '<div class="name-block text-center txt-up"><span>Новости колледжа</span></div>';
