...
<div class="page-content">
	...
	<div class="structure clear">
		...
		if($_REQUEST['sect'] == 'programs'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/universities/programs.php');
		endif;
		if($_REQUEST['sect'] == 'corpus'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/universities/corpus.php');
		endif;
		if($_REQUEST['sect'] == 'fakultets'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/universities/fakultets.php');
		endif;
		if($_REQUEST['sect'] == 'fillials'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/universities/fillials.php');
		endif;
		if($_REQUEST['sect'] == 'units'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/universities/units.php');
		endif;
		if($_REQUEST['sect'] == 'obchegitie'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/universities/obchegitie.php');
		endif;
		if($_REQUEST['sect'] == 'ring'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/universities/ring.php');
		endif;
		if($_REQUEST['sect'] == 'sections'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/universities/sections.php');
		endif;
		if($_REQUEST['sect'] == 'admins'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/universities/admins.php');
		endif;
		if($_REQUEST['sect'] == 'vacancies'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/universities/vacancies.php');
		endif;
		?>
	</div><!-- structure -->
</div>