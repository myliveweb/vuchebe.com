...
#form-group-chat .js-error-block {
  margin-left: 10px;
  font-size: 13px;
  display: none;
}
#form-group-chat .js-clear-div {
  text-align: center; 
  margin: 5px; 
  display: none;
}
#form-group-chat .js-clear-div span {
  cursor: pointer; 
  border-bottom: 1px dashed #9f9f9f; 
  position: relative; 
  top: 12px;
...
#form-group-chat .profile-avatar {
    width: auto;
    height: auto;
}
...
<div class="hideForm-group-chat group-chat">
	<div class="foneBg" onClick="close_form();"></div>
  	<div class="form-open-block">
	  	<form id="form-group-chat" method="post" action="">
			<div>
				<div class="name_form text-center"><span>Настройки группового чата</span></div>
        ...
        <div class="row-line">
            <div class="col-2">
                <div class="image brd rad-50">
                    <?
                    $avatar_url = SITE_TEMPLATE_PATH . "/images/noimage.png";
                    ?>
                    <input type="file" id="avatarGroup" data-type="avatar" accept="image/*">
                    <label for="avatarGroup" style="top: -14px; margin-bottom: 0;">
                        <img id="group-profile-avatar" class="profile-avatar" style="cursor: pointer;" src="<?=$avatar_url?>" alt="img">
                    </label>
                </div>
            </div>
            <div class="col-10">
                <div class="label">Название группового чата<span class="color-orange js-error-block js-error-name"></span></div>
                <input class="js-name" name="name" type="text" value="" />
            </div>
        </div>
        <div class="row-line mt-15">
          <div class="col-12">
            <div class="label" style="display: inline-block;">Участники группового чата</div><div style="display: inline-block;"><span class="color-orange js-error-block js-error-group-user"></span></div><div class="label" style="display: inline-block; float: right;">Администратор</div>
          </div>
        </div>
          ...
          <div class="row-line mt-10 user-group-chat owner" data-id="<?php echo $_SESSION['USER_DATA']['ID']; ?>">
            <div class="col-12">
              <div class="<?php echo $classAvatar; ?>">
                <a href="/user/<?php echo $url; ?>/" target="_blank"><img src="<?php echo $_SESSION['USER_DATA']['AVATAR']; ?>"/></a>
              </div>
              <div class="user-name-st name">
                  <a href="/user/<?php echo $url; ?>/" target="_blank"><?php echo $nameDisplay; ?></a>
              </div>
              <div class="label user-name-st check">
                <label class="radio">
                    <input class="js-admin" type="checkbox" name="admin[]" value="<?php echo $_SESSION['USER_DATA']['ID']; ?>" checked />
        ...
        <div class="row-line mt-15" style="margin-top: 15px;">
          <div class="col-12">
            <div class="label" style="display: inline-block;">Добавить участника</div>
              <label class="radio" style="display: inline-block; margin-left: 30px; position: relative;">
                  ...
                  <div class="radio__text">в закладках</div>
              </label>
