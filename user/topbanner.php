<?php
$APPLICATION->SetTitle("Оформление заказа - Верхний баннер");
global $USER;
...
$banner_url = SITE_TEMPLATE_PATH . "/images/empty_banner.png";
...
<div class="st-content-right">
	<div class="breadcrumbs">
		<a href="/">Главная</a> <i class="fa fa-angle-double-right color-orange"></i> <a href="/user/<?php echo $url; ?>/">Профиль</a> <i class="fa fa-angle-double-right color-orange"></i> <a href="/user/<?php echo $url; ?>/neworder/">Оформление заказа</a> <i class="fa fa-angle-double-right color-orange"></i> <span>Верхний баннер</span>
	</div>
  ...
  <div class="page-content form-banner error-banner" style="margin-top: 15px; display: none;">
	...
	<div id="page" class="page-content form-banner start-banner" style="margin-top: 15px;">
      ...
      <div style="height: 22px;"><span class="color-orange js-error-block js-error-img" style="margin-left: 15px;"></span></div>
			<div class="col-9">
				<div class="image brd">
					<input type="file" id="top-banner" data-type="banner" accept="image/*">
					<label for="top-banner" style="border-radius: 0;">
						<img data-type="top" class="top-banner profile-banner" style="cursor: pointer; width: 100%; max-width: 432px; max-height: 64px; margin: 0;" src="<?php echo $banner_url; ?>" alt="">
					</label>
				</div>
        ...
        <div class="row-line" style="margin-top: 15px;">
            <div class="col-12">
                <div class="label">Выбранный тариф: <span class="tarif-name js-tarif" data-tarif="BASE" data-type="top"></span> (<span class="js-cost"></span>)</div>
            </div>
        </div>
        <div class="row-line">
