...
<div class="st-content-right">
	<div class="breadcrumbs">
 		<a href="/">Главная</a> <i class="fa fa-angle-double-right color-orange"></i> <a href="/uchebnye-zavedeniya/">Учебные заведения</a> <i class="fa fa-angle-double-right color-orange"></i> Языковые курсы
	</div>
	<div class="page-content" id="page">
		<div class="name-block text-center txt-up"><span>Языковые курсы</span></div>
