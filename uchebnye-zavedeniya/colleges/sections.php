...
<div style="text-align: center; margin: -5px auto 25px auto;">
	<span class="color-silver js-new-add" data-vuz="<?=$arResult["ID"]?>" data-type="sections" data-iblock="3" style="cursor: pointer; border-bottom: 1px dashed #9f9f9f;">Добавить секцию</span>
</div>
<?php } ?>
<?php
	...
	<div class="module st-news">
		<div class="line" id="box-line">
			<div class="news-item one" style="position: relative;">
				<?if($pageAdmin):?>
				<div class="color-silver js-news-edit" data-block="sections" data-id="<?php echo $id_section; ?>" data-iblock="3" style="position: absolute; right: 5px; cursor: pointer; border-bottom: 1px dashed #9f9f9f;">изменить</div>
				<?endif?>
...
<?php
	...
	<div class="news-item" style="position: relative;">
		<?if($pageAdmin):?>
		<div class="color-silver js-news-edit" data-block="sections" data-id="<?php echo $sections_id; ?>" data-iblock="3" style="position: absolute; right: 5px; cursor: pointer; border-bottom: 1px dashed #9f9f9f;">изменить</div>
		<?endif?>
		<div class="news-name">
