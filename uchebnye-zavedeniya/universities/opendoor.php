...
<div style="text-align: center; margin: -5px auto 25px auto;">
	<span class="color-silver js-new-add" data-vuz="<?=$arResult["ID"]?>" data-type="opendoor" data-iblock="2" style="cursor: pointer; border-bottom: 1px dashed #9f9f9f;">Новый день открытых дверей</span>
</div>
<?php } ?>
<script>
var curPage = 'universities';
