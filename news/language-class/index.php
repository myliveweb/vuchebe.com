...
$APPLICATION->SetTitle("Новости языковых курсов");
$current_razdel = 'news-language-class';
...
if(isset($_SESSION['PANEL']['CITY']) && $_SESSION['PANEL']['CITY'] && $_SESSION['PANEL']['TOPCITY'])
	$arFilterEvent = array("IBLOCK_ID" => 6, "ACTIVE" => "Y", "!PROPERTY_ADD_EVENTS" => false, "PROPERTY_CITY" => $_SESSION['PANEL']['CITY']);
elseif(isset($_SESSION['PANEL']['REGION']) && $_SESSION['PANEL']['REGION'])
	$arFilterEvent = array("IBLOCK_ID" => 6, "ACTIVE" => "Y", "!PROPERTY_ADD_EVENTS" => false, "PROPERTY_REGION" => $_SESSION['PANEL']['REGION']);
else
	$arFilterEvent = array("IBLOCK_ID" => 6, "ACTIVE" => "Y", "!PROPERTY_ADD_EVENTS" => false, "PROPERTY_COUNTRY" => $_SESSION['PANEL']['COUNTRY']);
...
<div class="st-content-right">
	<div class="breadcrumbs">
		<a href="/">Главная</a> <i class="fa fa-angle-double-right color-orange"></i> <a href="/news/">Новости учебных заведений</a> <i class="fa fa-angle-double-right color-orange"></i>  <span>Новости языковых курсов</span>
	</div>
