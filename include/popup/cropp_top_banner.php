<div class="hideForm-top-banner top-banner" style="display: none; z-index: 920;">
	<div class="foneBg" onClick="close_form();" style="position: fixed;"></div>
  	<div class="form-open-block">
	  	<form id="top-banner-popup" method="post" action="" style="width: 610px;">
			<div>
				<div class="name_form text-center"><span>Редактирование баннера</span></div>
                ...
                <div class="row-line">
                    <div class="col-12" style="text-align: center;">
                        <div style="text-align: center; margin: 15px auto; font-size: 18px; position: relative;">
                            <div id="upload-input" data-avatar="top-banner" style=" margin: 0 auto;"></div>
