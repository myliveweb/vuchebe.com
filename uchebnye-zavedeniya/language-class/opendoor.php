...
<div style="text-align: center; margin: -5px auto 20px auto;">
	<span class="color-silver js-new-add" data-vuz="<?=$arResult["ID"]?>" data-type="opendoor" data-iblock="6" style="cursor: pointer; border-bottom: 1px dashed #9f9f9f;">Новый день открытых дверей</span>
</div>
<?php } ?>
<script>
var curPage = 'language-class';
