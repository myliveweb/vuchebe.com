    ...
    <div>
        ...
        <div class="row-line">
            <div class="col-12">
                ...
                <input name="name" class="name js-moderate" type="text" value="<?php echo $input['name']; ?>" />
            </div>
        </div>
        ...
        <div class="row-line mt-10">
            <div class="col-12">
                ...
                <input name="email" class="email js-moderate" type="text" value="<?php echo $input['email']; ?>" />
            </div>
        </div>
        <div class="row-line mt-10">
            <div class="col-12">
                <div class="label">Пароль<span class="error-text error-password"><?php if($error['password']) { echo $error['password']; } ?></span></div>
                <input name="password" class="password js-moderate" type="password" value="<?php echo $input['password']; ?>" />
            </div>
        </div>
        <div class="row-line mt-10">
            <div class="col-12">
                <div class="label">Повторите пароль<span class="error-text error-confirm-password"><?php if($error['confirm_password']) { echo $error['confirm_password']; } ?></span></div>
                <input name="confirm_password" class="confirm-password js-moderate" type="password" value="<?php echo $input['confirm_password']; ?>" />
            </div>
        </div>
        <div class="row-line mt-10">
            <div class="col-12">
        ...
        <div class="row-line mb-10" style="margin-top: 25px;">
            <div class="col-4">
                <button type="submit" class="js-submit-moderate"><span>Отправить</span></button>
            </div>
        </div>
    </div>
</form>