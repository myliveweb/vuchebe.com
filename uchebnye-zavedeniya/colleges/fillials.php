...
<div style="text-align: center; margin: -5px auto 25px auto;">
	<span class="color-silver js-new-add" data-vuz="<?=$arResult["ID"]?>" data-type="fillials" data-iblock="3" style="cursor: pointer; border-bottom: 1px dashed #9f9f9f;">Добавить филиал</span>
</div>
<?php } ?>
<?php
	...
	<div class="line" id="box-line">
		...
		<div class="news-item">
			...
			<div style="position: relative; right: 5px; text-align: right;">
				<div class="color-silver js-news-edit" data-block="fillials" data-id="<?php echo $id_filials; ?>" data-iblock="3" style="cursor: pointer; border-bottom: 1px dashed #9f9f9f; display: inline-block;">изменить</div>
			</div>
			<?endif?>
            <? if($map) { ?>
