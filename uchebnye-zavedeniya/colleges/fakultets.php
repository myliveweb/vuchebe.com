...
<div style="text-align: center; margin: -5px auto 25px auto;">
	<span class="color-silver js-new-add" data-vuz="<?=$arResult["ID"]?>" data-type="fakultets" data-iblock="3" style="cursor: pointer; border-bottom: 1px dashed #9f9f9f;">Добавить факультет или институт</span>
</div>
<?php } ?>
<?php
		...
		<div class="line" id="box-line">
			<div class="news-item one">
				...
				<div style="position: relative; top: -10px; right: 5px; text-align: right;">
					<div class="color-silver js-news-edit" data-block="fakultets" data-id="<?php echo $id_section; ?>" data-iblock="3" style="cursor: pointer; border-bottom: 1px dashed #9f9f9f; display: inline-block;">изменить</div>
				</div>
				<?endif?>
				<? if($section[2]) { ?>
...
<?php
	...
	<div class="news-item">
		...
		<?if($pageAdmin):?>
		<div style="position: relative; top: -10px; right: 5px; text-align: right;">
			<div class="color-silver js-news-edit" data-block="fakultets" data-id="<?php echo $sections_id; ?>" data-iblock="3" style="cursor: pointer; border-bottom: 1px dashed #9f9f9f; display: inline-block;">изменить</div>
		</div>
		<?endif?>
		<? if($arrItem[2]) { ?>
			<div class="btns text-right"><a href="#" class="button"><span style="font-family: Verdana;">на карте</span></a></div>
