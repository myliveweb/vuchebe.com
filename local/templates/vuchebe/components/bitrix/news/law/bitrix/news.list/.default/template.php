...
<div class="st-content-right">
    ...
    <div class="breadcrumbs">
        <a href="/">Главная</a> <i class="fa fa-angle-double-right color-orange"></i> <a href="/company/">Компания</a> <i class="fa fa-angle-double-right color-orange"></i> Правовая информация
    </div>

    <div class="page-content">
        <div class="st-content-bottom clear">
            <div class="name-block text-left" style="margin-bottom: 30px;"> &nbsp;&nbsp;<span>Правовая информация</span></div>

            <?foreach($arResult["ITEMS"] as $arItem):?>
                <?
                if($arItem["PROPERTIES"]["MENU"]["VALUE"] != 'Y')
                    continue;
