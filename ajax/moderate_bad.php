...
if($id) {
    CIBlockElement::SetPropertyValueCode($id, "REASON", $text);
    CIBlockElement::SetPropertyValueCode($id, "REJECTED", 'Y');
    CIBlockElement::SetPropertyValueCode($id, "LAUNCHED", 'N');
    CIBlockElement::SetPropertyValueCode($id, "MODERATION", 'N');
