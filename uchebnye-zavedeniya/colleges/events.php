...
<div style="text-align: center; margin: -5px auto 25px auto;">
	<span class="color-silver js-new-add" data-vuz="<?=$arResult["ID"]?>" data-type="events" data-iblock="3" style="cursor: pointer; border-bottom: 1px dashed #9f9f9f;">Добавить событие</span>
</div>
<?php } ?>
<?php
global $dbh;
...
<div class="page-content" id="page">
	<div class="name-block text-center txt-up"><span>События колледжа</span></div>
