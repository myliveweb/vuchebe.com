...
<div class="st-content-right">
    ...
    <div class="page-content st-content-users" id="page" data-type="moderate">
        <!-- Поиск -->
        ...
        <!-- End Поиск -->
		<div class="name-block text-center txt-up" style="margin: 0 0 15px;"><span>Выставление счёта</span></div>
        ...
        <div class="params-banner-top col-12" style="margin-top: 15px; text-align: right;">
            <a class="color-silver js-check-button add" data-type="add" data-id="<?php echo $arrData["ID"]; ?>" data-user="<?=$arrData['USER']?>" data-sum="<?php echo $arrData["SUM"]; ?>">Выставить счёт</a>
            <a class="color-silver js-check-button pay" data-type="pay" data-id="<?php echo $arrData["ID"]; ?>" data-user="<?=$arrData['USER']?>" data-sum="<?php echo $arrData["SUM"]; ?>">Оплачен</a>
