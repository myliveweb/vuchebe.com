					...
					<div class="select<?if($_REQUEST['sect'] == 'teacher'):?> st-cheked<?endif?>">
						<div class="style-input">
 							<a href="<?=$arResult["DETAIL_PAGE_URL"]?>?sect=teacher" class="a-label">
								<div>Преподаватели колледжа</div>
 							</a>
						</div>
					</div>
					 <!-- select -->
