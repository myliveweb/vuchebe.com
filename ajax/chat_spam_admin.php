...
CIBlockElement::SetPropertyValueCode($id, "TICKET", $ticket);
...
if($chat && $message && $user) {
    ...
    $arFilterCntTicket = Array("IBLOCK_ID" => 27, "ACTIVE" => "Y", "!PROPERTY_TICKET" => false, "PROPERTY_AUTHOR" => $userData['ID']);
