...
<div class="page-content">
	...
	<div class="structure clear">
		...
		if($_REQUEST['sect'] == 'programs'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/colleges/programs.php');
		endif;
		if($_REQUEST['sect'] == 'corpus'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/colleges/corpus.php');
		endif;
		if($_REQUEST['sect'] == 'fakultets'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/colleges/fakultets.php');
		endif;
		if($_REQUEST['sect'] == 'fillials'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/colleges/fillials.php');
		endif;
		if($_REQUEST['sect'] == 'units'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/colleges/units.php');
		endif;
		if($_REQUEST['sect'] == 'obchegitie'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/colleges/obchegitie.php');
		endif;
		if($_REQUEST['sect'] == 'ring'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/colleges/ring.php');
		endif;
		if($_REQUEST['sect'] == 'sections'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/colleges/sections.php');
		endif;
		if($_REQUEST['sect'] == 'admins'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/colleges/admins.php');
		endif;
		if($_REQUEST['sect'] == 'vacancies'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/colleges/vacancies.php');
		endif;
		?>
	</div><!-- structure -->
</div>