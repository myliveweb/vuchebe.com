...
<div class="page-content">
	...
	<div class="structure clear">
		...
		if($_REQUEST['sect'] == 'programs'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/language-class/programs.php');
		endif;
		if($_REQUEST['sect'] == 'corpus'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/language-class/corpus.php');
		endif;
		if($_REQUEST['sect'] == 'fakultets'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/language-class/fakultets.php');
		endif;
		if($_REQUEST['sect'] == 'fillials'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/language-class/fillials.php');
		endif;
		if($_REQUEST['sect'] == 'units'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/language-class/units.php');
		endif;
		if($_REQUEST['sect'] == 'obchegitie'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/language-class/obchegitie.php');
		endif;
		if($_REQUEST['sect'] == 'ring'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/language-class/ring.php');
		endif;
		if($_REQUEST['sect'] == 'sections'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/language-class/sections.php');
		endif;
		if($_REQUEST['sect'] == 'admins'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/language-class/admins.php');
		endif;
		if($_REQUEST['sect'] == 'vacancies'):
			require($_SERVER["DOCUMENT_ROOT"].'/uchebnye-zavedeniya/language-class/vacancies.php');
		endif;
		?>
	</div><!-- structure -->
</div>