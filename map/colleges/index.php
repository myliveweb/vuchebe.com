...
$arFilter = array("ACTIVE" => "Y", "IBLOCK_ID" => 3);
...
function init(){
	...
	<?php foreach($geo as $idObj => $item) { ?>
	    ...
	    iconImageHref: '<?php echo SITE_TEMPLATE_PATH; ?>/images/bal-6.png',
	    iconImageSize: [29, 39],
