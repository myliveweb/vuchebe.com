<div class="page-content">
	...
	<div class="name-block text-center txt-up"><span>История школы</span></div>
		...
		<div class="module st-news">
			...
			<div class="line">
				...
				<div class="news-item one" style="position: relative;">
					<?if($pageAdmin):?>
					<div class="color-silver js-vuz-edit" data-block="history" data-iblock="4" style="position: absolute; top: -25px; right: 5px; cursor: pointer; border-bottom: 1px dashed #9f9f9f;">изменить</div>
					<?endif?>
					<?php
					if($pageAdmin) {
						?>
						<div class="image brd left">
							<input type="file" id="file" data-type="history" data-id="<?php echo $arResult["ID"]; ?>" data-iblock="4" accept="image/*">
							<label for="file">
							<?php
	...
	<? } else { ?>
		<div class="module st-news">
			<div class="line">
				<div class="news-item one" style="position: relative;">
					<?if($pageAdmin):?>
					<div class="color-silver js-vuz-edit" data-block="history" data-iblock="4" style="position: absolute; top: -15px; right: 5px; cursor: pointer; border-bottom: 1px dashed #9f9f9f;">изменить</div>
					<?endif?>
				</div>
			</div>
		</div><!-- st-news -->
