...
<?else:?>
	...
	<?if ($arResult["NavPageNomer"] > 1):?>
		...
		<?if($arResult["bSavePage"]):?>
			<a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=1">&laquo;</a>
	...
	<?if($arResult["NavPageNomer"] < $arResult["NavPageCount"]):?>
		...
		<a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=$arResult["NavPageCount"]?>">&raquo;</a>
	<?else:?>
		<span>&raquo;</span>
	<?endif?>
