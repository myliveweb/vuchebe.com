<div class="hideForm-side-banner side-banner" style="display: none; z-index: 920;">
	<div class="foneBg" onClick="close_form();" style="position: fixed;"></div>
  	<div class="form-open-block">
	  	<form id="side-banner-popup" method="post" action="">
			<div>
                ...
                <div class="row-line">
                    <div class="col-12" style="text-align: center;">
                        <div style="text-align: center; margin: 15px auto; font-size: 18px; position: relative;">
                            <div id="upload-input" data-avatar="side-banner" style=" margin: 0 auto;"></div>
