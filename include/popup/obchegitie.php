<div class="hideForm-news-edit obchegitie">
	<div class="foneBg" onClick="close_form();"></div>
  	<div class="form-open-block">
	  	<form id="form-news-obchegitie" method="post" action="">
			<div>
				<div class="name_form text-center"><span>Редактирование общежития</span></div>
				...
				<div class="row-line mt-10">
					<div class="col-6">
						...
						<input class="phone-obchegitie js-news-edit-form error-reset" type="text">
					</div>
					<div class="col-6">
				...
				<div class="row-line mb-10 mt-15 css-btn">
					<div class="col-4">
						<button type="submit" class="js-submit-news-edit" data-form="obchegitie"><span>Сохранить</span></button>
					</div>
					<div class="col-4">
						<button type="button" style="background-color: #a7a7a7;" class="js-del-news gray" data-form="obchegitie"><span>Удалить</span></button>
					</div>
				</div>
...
</div><!-- hideForm-news-edit obchegitie -->